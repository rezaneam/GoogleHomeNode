...
void BLElite::Initialize(std::string deviceName, void (*event_queue_method)(CustomEvents), bool verbose)
{
    ...
    addCharacteristic(pAutomationService, CHARACTERISTIC_UUID_WIFI_SSID, NIMBLE_PROPERTY::READ | NIMBLE_PROPERTY::WRITE, GetFlashValue(EEPROM_VALUE::WiFi_SSID));
    ...
    addCharacteristic(pAutomationService, CHARACTERISTIC_UUID_GOOGLE_HOME_NAME, NIMBLE_PROPERTY::READ | NIMBLE_PROPERTY::NOTIFY | NIMBLE_PROPERTY::WRITE, GetFlashValue(EEPROM_VALUE::Google_Home_Name), DESCRIPTOR_UUID_GLHM_NAME, DESCRIPTOR_VAL_GLHM_NAME);
    ...
    addCharacteristic(pAutomationService, CHARACTERISTIC_UUID_DEVICE_LOCATION, NIMBLE_PROPERTY::READ | NIMBLE_PROPERTY::WRITE, GetFlashValue(EEPROM_VALUE::Device_Location));
    addCharacteristic(pAutomationService, CHARACTERISTIC_UUID_USER_NAME, NIMBLE_PROPERTY::READ | NIMBLE_PROPERTY::WRITE, GetFlashValue(EEPROM_VALUE::User_Name));
